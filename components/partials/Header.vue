<template>
  ...
  >
    <div
      class="flex items-center flex-shrink-0 text-white mr-6 text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary"
    >
      <svg
      ...
      <span
        class="font-semibold text-3xl tracking-tight text-light-onSurfacePrimary dark:text-dark-onSurfacePrimary"
      >
        Coinsly
      </span>
    </div>
